...
func (_c *SessionCreate) SetCsrfHash(v string) *SessionCreate {
...
func (_c *SessionCreate) check() error {
	...
	if _, ok := _c.mutation.CsrfHash(); !ok {
		return &ValidationError{Name: "csrf_hash", err: errors.New(`ent: missing required field "Session.csrf_hash"`)}
	}
