...
func (_c *ReactionCreate) SetDeletedAt(v time.Time) *ReactionCreate {
	_c.mutation.SetDeletedAt(v)
	return _c
}

// SetNillableDeletedAt sets the "deleted_at" field if the given value is not nil.
func (_c *ReactionCreate) SetNillableDeletedAt(v *time.Time) *ReactionCreate {
	if v != nil {
		_c.SetDeletedAt(*v)
	}
	return _c
...
func (_c *ReactionCreate) SetWorkspaceID(v uuid.UUID) *ReactionCreate {
	_c.mutation.SetWorkspaceID(v)
	return _c
}

// SetProjectID sets the "project_id" field.
func (_c *ReactionCreate) SetProjectID(v uuid.UUID) *ReactionCreate {
	_c.mutation.SetProjectID(v)
	return _c
}

// SetWorkItemID sets the "work_item_id" field.
func (_c *ReactionCreate) SetWorkItemID(v uuid.UUID) *ReactionCreate {
	_c.mutation.SetWorkItemID(v)
	return _c
}

// SetNillableWorkItemID sets the "work_item_id" field if the given value is not nil.
func (_c *ReactionCreate) SetNillableWorkItemID(v *uuid.UUID) *ReactionCreate {
	if v != nil {
		_c.SetWorkItemID(*v)
	}
	return _c
...
func (_c *ReactionCreate) SetCommentID(v uuid.UUID) *ReactionCreate {
	_c.mutation.SetCommentID(v)
	return _c
}

// SetNillableCommentID sets the "comment_id" field if the given value is not nil.
func (_c *ReactionCreate) SetNillableCommentID(v *uuid.UUID) *ReactionCreate {
	if v != nil {
		_c.SetCommentID(*v)
	}
	return _c
...
func (_c *ReactionCreate) SetUserID(v uuid.UUID) *ReactionCreate {
...
func (_c *ReactionCreate) check() error {
	...
	if _, ok := _c.mutation.WorkspaceID(); !ok {
		return &ValidationError{Name: "workspace_id", err: errors.New(`ent: missing required field "Reaction.workspace_id"`)}
	}
	if _, ok := _c.mutation.ProjectID(); !ok {
		return &ValidationError{Name: "project_id", err: errors.New(`ent: missing required field "Reaction.project_id"`)}
	}
