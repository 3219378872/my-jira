...
const (
	// Label holds the string label denoting the publicvote type in the database.
	Label = "public_vote"
	...
	FieldUserID = "user_id"
	// Table holds the table name of the publicvote in the database.
	Table = "public_votes"
)

// Columns holds all SQL columns for publicvote fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the PublicVote queries.
