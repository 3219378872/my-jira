...
const (
	// Label holds the string label denoting the workitemlabel type in the database.
	...
	// Table holds the table name of the workitemlabel in the database.
	Table = "work_item_labels"
)

// Columns holds all SQL columns for workitemlabel fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the WorkItemLabel queries.
