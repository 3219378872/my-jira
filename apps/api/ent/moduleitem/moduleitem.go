...
const (
	// Label holds the string label denoting the moduleitem type in the database.
	Label = "module_item"
	...
	// Table holds the table name of the moduleitem in the database.
	Table = "module_items"
)

// Columns holds all SQL columns for moduleitem fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ModuleItem queries.
