...
func WorkspaceIDGT(v uuid.UUID) predicate.APIToken {
	return predicate.APIToken(sql.FieldGT(FieldWorkspaceID, v))
}

// WorkspaceIDGTE applies the GTE predicate on the "workspace_id" field.
func WorkspaceIDGTE(v uuid.UUID) predicate.APIToken {
	return predicate.APIToken(sql.FieldGTE(FieldWorkspaceID, v))
}

// WorkspaceIDLT applies the LT predicate on the "workspace_id" field.
func WorkspaceIDLT(v uuid.UUID) predicate.APIToken {
	return predicate.APIToken(sql.FieldLT(FieldWorkspaceID, v))
}

// WorkspaceIDLTE applies the LTE predicate on the "workspace_id" field.
func WorkspaceIDLTE(v uuid.UUID) predicate.APIToken {
	return predicate.APIToken(sql.FieldLTE(FieldWorkspaceID, v))
}
