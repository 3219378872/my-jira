...
const (
	// Label holds the string label denoting the cycleitem type in the database.
	Label = "cycle_item"
	...
	// Table holds the table name of the cycleitem in the database.
	Table = "cycle_items"
)

// Columns holds all SQL columns for cycleitem fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the CycleItem queries.
