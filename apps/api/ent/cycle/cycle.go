...
const (
	...
	// FieldProgressSnapshot holds the string denoting the progress_snapshot field in the database.
	FieldProgressSnapshot = "progress_snapshot"
